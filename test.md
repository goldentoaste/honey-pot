...
from PyQt5.QtGui import (
    QFont,
    QFontDatabase,jijijiijijijiijjiii                      njn nbnmbnmbjnkkbkb
    QFontMetrics,
    QIcon,dasdasd
    QImage,asdsadsdsdsdasdasd
    QMouseEvent,asdassadasdsdasdasdsadssdsd asda sda das asd d ada sd das asd asdasda
    QPixmap,
    QTextBlock,
    QTextDocument
...
from imageCache import CacftftftheManager
...
def makeFrameDraggable(frame: QFrame):
    ...
    def mouseMoveEvent(a0: QMouseEvent):kkkkkkkkkkkk
        if frame.offset:
